...
function adjust() {
        ...
        if (width <= 500) {
                navigation.innerHTML = ""
                        ...
                        + "<ul class='l2'>"
                        + "<li><a href='javascript:void(0)' class='navLink' onclick='onClickPage(\"driverPanel.html\")'</a>DRIVER</li>"
                        + "<li><a href='javascript:void(0)' class='navLink' onclick='onClickPage(\"passengerPage.html\")'>PASSENGER</a></li>"
                        + "</ul></li>"
                ...
                navigation.innerHTML = ""
                        + "<div class='nva'>"
                        + "<ul class='l1'>"
                        + "<li><a href='javascript:void(0)' class='navLink' onclick='onClickPage(\"driverPanel.html\")'>DRIVER</a></li>"
                        + "<li><a href='javascript:void(0)' class='navLink' onclick='onClickPage(\"passengerPage.html\")'>PASSENGER</a></li>"
                        + "<div class='header_right'><a id='statusinfo' href='javascript:void(0)' onclick='statusOperation()' class='navLink'></a></div>"
                        + "</ul>"
                        + "</div>";
